...
export default function Hero() {
  ...
  return (
    <section id="about" className="min-h-screen pt-32 md:pt-40 pb-16 flex items-center relative overflow-hidden bg-background">
      {/* Background accents - subtly matching the Digital Atelier vibe */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[50%] h-[100%] bg-gradient-to-bl from-[#5dd7e6]/5 to-transparent opacity-30"></div>
        <div className="absolute bottom-0 left-0 w-[40%] h-[60%] bg-gradient-to-tr from-[#005f68]/5 to-transparent opacity-30"></div>
      </div>
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            {isLoaded && (
              ...
              >
                <motion.h2 
                  ...
                  className="text-sm font-medium uppercase tracking-widest text-[#5dd7e6] mb-4 leading-relaxed"
                >
                ...
                >
                  ...
                  <span className="relative">
                    <span className="relative z-10 bg-gradient-to-r from-[#5dd7e6] to-[#8df2ff] bg-clip-text text-transparent font-extrabold">
                      Complex Data
                    </span>
                  </span>{" "}
                ...
                <motion.p 
                  variants={itemVariants} 
                  className="text-xl text-[#bec8ca] mb-8 max-w-lg font-light leading-relaxed"
                >
                ...
                >
                  {skills.map((skill, index) => (
                    ...
                    >
                      <Badge 
                        variant="outline" 
                        className={`${getColorClasses(skill.color)} px-3 py-1 text-xs font-medium border`}
                      >
                        {skill.name}
                      </Badge>
                    </motion.div>
                ...
                <div className="flex flex-wrap gap-4">
                  <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
                    <Button 
                      asChild
                      size="lg"
                      className="bg-gradient-to-r from-[#5dd7e6] to-[#005f68] text-[#00363c] font-bold transition-all duration-300 border-0 shadow-[0_4px_14px_rgba(93,215,230,0.2)]"
                    >
                  ...
                  <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
                    <Button 
                      ...
                      size="lg"
                      asChild
                      className="border border-[#3f484a] text-[#e5e2e1] hover:bg-[#5dd7e6]/5 transition-all duration-300 bg-transparent"
                    >
          ...
          >
            <div className="aspect-square rounded-2xl overflow-hidden border border-[#5dd7e6]/20 shadow-[0_0_50px_rgba(93,215,230,0.05)] relative z-10">
              <img 
                src={image}
                alt="Soumodwip Mondal" 
                className="w-full h-full object-cover grayscale-[0.1] contrast-[1.05]"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#121212]/40 to-transparent"></div>
            </div>

            {/* Decorative background accent */}
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-[#5dd7e6]/10 rounded-full blur-3xl -z-10"></div>
            <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-[#005f68]/15 rounded-full blur-3xl -z-10"></div>
          </motion.div>
        </div>
      </div>
    </section>
